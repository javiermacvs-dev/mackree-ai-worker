...
| Build version | leer `BUILD_VERSION` en `server.js` (código: `v79-subtitle-position`, LIVE verificado por `/health` el 2026-08-12). ⚠️ **producción puede seguir en la versión anterior** si Easypanel no reinició tras el push — verificar SIEMPRE con `/health`, no confiar en el verde (error #17) |
