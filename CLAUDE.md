...
| Build version | leer `BUILD_VERSION` en `server.js` (código: `v81-r2-dual-storage`, pusheado 2026-08-14). ⚠️ **producción puede seguir en la versión anterior** si Easypanel no reinició tras el push — verificar SIEMPRE con `/health`, no confiar en el verde (error #17) |
