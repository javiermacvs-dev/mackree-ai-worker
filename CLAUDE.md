...
| Build version | leer `BUILD_VERSION` en `server.js` (código: `v80-duck-energy-gate`, pusheado 2026-08-13). ⚠️ **producción puede seguir en la versión anterior** si Easypanel no reinició tras el push — verificar SIEMPRE con `/health`, no confiar en el verde (error #17) |
