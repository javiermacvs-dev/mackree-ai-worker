...
export const STYLES = {
  doodle: {
    ...
    prompt_base:
      'hand-drawn doodle illustration, black marker line art on clean white background, simple stick figures, minimal neutral colors with one accent color (limon green or yellow), educational explainer style, casual friendly',
  },
  whiteboard: {
