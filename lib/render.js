...
async function renderEdit({ workDir, openaiKey, manifest }) {
  ...
  // v28 INAMOVIBLE (Javier 2026-05-19 03:25 UTC): "un poquito más volumen música".
  // Subido commercial 0.06 → 0.10, personal 0.12 → 0.14. NO bajar de estos valores.
  const musicVol = isCommercial ? 0.10 : 0.14
