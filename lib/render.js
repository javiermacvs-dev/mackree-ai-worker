  ...
  if (wantSilenceTrim) {
    for (let i = 0; i < probed.length; i++) {
      ...
      if (item.type === 'video' && item.hasAudio) {
        ...
        // v14: modo super-agresivo con silencios — Javier dijo "no importa
        // que el video no quede del tiempo elegido, cortá todas las pausas
        // y espacios de pensamiento". Antes: 0.8s/-30dB/0.1s padding.
        // Ahora corta cualquier pausa >0.35s con umbral -28dB y padding 0.05s.
