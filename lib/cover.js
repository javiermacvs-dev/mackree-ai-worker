...
export async function generateCover({ framePath, videoPath, format, logoPath, workDir, fields = {}, outName = 'cover.png' }) {
  ...
  if (subtitle) {
    ...
    capcutText(ctx, W / 2, H * (isVertical ? 0.9 : 0.88), subtitle, '#FFFFFF', { strokeW: Math.max(6, fitted * 0.09) })
  }
