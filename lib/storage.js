 ...
 * Reemplaza si existe. Devuelve URL pública.
 */
 ...
 * Devuelve la URL PÚBLICA completa (igual que uploadOutput/uploadThumbnail).
 * Antes devolvía el path relativo → el <img> del frontend lo resolvía contra el
 * dominio del SaaS → 404 (ícono roto). El bucket video-jobs es público.
 */
